#include "serde/serialization/mapper/aggregate/AggregateSerializerMapper.hpp"
...
namespace {
    ...
    class SerializationFunctionsMapper final : public ISerializationFunctionsMapper<std::string, std::type_info> {
    ...
    public:
        ...
        {
            std::type_index type_index_v(type_info_v);
...
TEST(AggregateSerializerMapper, AddGetFunction) {
    FieldsGetter getter;
...
TEST(AggregateSerializerMapper, AddSameKeyException) {
    FieldsGetter getter;
...
TEST(AggregateSerializerMapper, GetUnknownKeyException) {
    AggregateSerializerMapper<std::string> aggregate_serializer_mapper;
